...
export class RegistrationService {
  ...
  public sign_up(request: ApiRequest<SignUpRequest>): Observable<ApiResponse<SignUpResponse>> {
    return this.http_client.post<ApiResponse<SignUpResponse>>(`${endpoints[SIGN_UP]}`, request);
  }
